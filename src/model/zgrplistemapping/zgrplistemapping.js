...
class ZGruppenlisteMapping extends DAO {

    /**
     * Overrides TABLE_NAME with this class' backing table at MySQL
     */
    static get TABLE_NAME() {
        return 'ZGruppenlisteMapping'
    }
     ...
     * Creates a new bacon
     */
    static async createEntry(_, {listeid, gruppeid}) {
     ...
     * Updates a bacon 
     */
    static async updateEntry(_, {id, listeid, gruppeid}) {
        const connection = await mySQLWrapper.getConnectionFromPool()
        try {
...
module.exports = ZGruppenlisteMapping